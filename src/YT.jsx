...
function YT({ globalSteps, setGlobalSteps, totalSteps, failedTracks, steps, trackSteps, songs }) {
	console.log({ globalSteps, totalSteps, failedTracks });
	return (
		<>
			...
			{songs.length > 0 ? (
				...
				<>
					<div className="flex flex-col text-muted h-full font-semibold w-full items-center justify-center">
						<div
                        ...
                        <label>Convert your spotify playlist</label>
                        <label>to YouTube Music</label>
						...
						<button
							...
							<div className="text-card rounded-[10px]">
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-import-icon lucide-import">
									<path d="M12 3v12" />
                        ...
                        <label>Haven't created a config yet? Create one from spotify</label>
					</div>
				</>
			)}
		</>
